...
submenu_1_2 = Menu(submenu_1, tearoff=0)
...
submenu_1.add_cascade(label="Importar contactos", menu=submenu_1_2)
...
submenu_1_2.add_command(label=".json", command=importar)
